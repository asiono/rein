...
grid <- TUD_grids[[6]]
rm(TUD_grids)
load("/home/asiono/Documents/Shiny_sven/grid.Rdata")
...
rein::reinforcement(grid, reinforcement_method = 'oltc', avail_asset_types = list(line = c("2xNAYY4x150", "2xNAYY4x240"), 
